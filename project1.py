...
net=jetson.inference.imageNet('alexnet',['model=home/jetsonfrancia/jetson-inference/python/training/classification/myModel/resnet18.onnx','--input_blob=input_0','--output_blob=output_0','--labels=home/jetsonfrancia/jetson-inference/myTrain/labels.txt'])
